...
def model(input_):
    ...
    """
    resput = convolution_2d(input_, 8, filter_size=1)
    output = elu(resput)
    ...
    resput = convolution_2d(output, 16, filter_size=1)
    output = elu(resput)
    ...
    output = elu(output)
    output = maxpooling_2d(output)
    resput = convolution_2d(output, 32, filter_size=1)
    output = elu(resput)
    ...
    output = elu(output)
    output = maxpooling_2d(output)
    resput = convolution_2d(output, 64, filter_size=1)
    output = elu(resput)
    ...
    output = elu(output)
    output = maxpooling_2d(output)
    resput = convolution_2d(output, 128, filter_size=1)
    output = elu(resput)
